# qbot-autoinstaller for everyone who doesn't understand linux
# copyright 2017-18 rivan juthani at Sat Oct 21 2017
...
def __start__():
  print('Welcome to qbot-autoinstaller...' + bcolors.OKGREEN)
...
def __downloadqbot__():
  ...
  os.system('git clone https://github.com/geniosa/qbot')
  print('----> DONE!' + bcolors.OKGREEN)
  return
...
def __screen___():
  ...
  time.sleep(5)
  os.system('screen ./server 23 1000 777')
  return
